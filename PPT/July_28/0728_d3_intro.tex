...
\begin{figure}
\includegraphics[width=0.6\textwidth]{./images/chord.png}
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{./images/stack.png}
...
\begin{figure}
\includegraphics[width=1.0\textwidth, height=0.7\textheight]{./images/cluster.png}
...
\begin{figure}
\includegraphics[width=1.0\textwidth, height=0.7\textheight]{./images/tree.png}
